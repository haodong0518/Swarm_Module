...
class Init_SetTwisting_Request_twist_state
{
public:
  Init_SetTwisting_Request_twist_state()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::dynamixel_sdk_custom_interfaces::srv::SetTwisting_Request twist_state(::dynamixel_sdk_custom_interfaces::srv::SetTwisting_Request::_twist_state_type arg)
  {
    msg_.twist_state = std::move(arg);
...
{
  return dynamixel_sdk_custom_interfaces::srv::builder::Init_SetTwisting_Request_twist_state();
}
