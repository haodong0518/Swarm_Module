...
#include "dynamixel_sdk_custom_interfaces/msg/detail/rolling__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dynamixel_sdk_custom_interfaces::msg::Rolling;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dynamixel_sdk_custom_interfaces::msg::Rolling *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dynamixel_sdk_custom_interfaces::msg::Rolling *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Rolling__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const dynamixel_sdk_custom_interfaces::msg::Rolling *>(
...
static size_t _Rolling__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Rolling(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Rolling__callbacks = {
...
static rosidl_message_type_support_t _Rolling__handle = {
...
{
  return &dynamixel_sdk_custom_interfaces::msg::typesupport_fastrtps_cpp::_Rolling__handle;
}
