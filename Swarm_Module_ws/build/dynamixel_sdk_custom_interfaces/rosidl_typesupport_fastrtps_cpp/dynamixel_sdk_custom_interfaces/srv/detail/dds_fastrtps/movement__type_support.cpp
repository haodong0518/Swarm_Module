...
#include "dynamixel_sdk_custom_interfaces/srv/detail/movement__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dynamixel_sdk_custom_interfaces::srv::Movement_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dynamixel_sdk_custom_interfaces::srv::Movement_Request & ros_message)
{
  // Member: movement
  cdr >> ros_message.movement;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dynamixel_sdk_custom_interfaces
max_serialized_size_key_Movement_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const dynamixel_sdk_custom_interfaces::srv::Movement_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dynamixel_sdk_custom_interfaces::srv::Movement_Request *>(
    untyped_ros_message);
...
{
  return &dynamixel_sdk_custom_interfaces::srv::typesupport_fastrtps_cpp::_Movement_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dynamixel_sdk_custom_interfaces, srv, Movement_Request)() {
  return &dynamixel_sdk_custom_interfaces::srv::typesupport_fastrtps_cpp::_Movement_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dynamixel_sdk_custom_interfaces
cdr_serialize(
  const dynamixel_sdk_custom_interfaces::srv::Movement_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dynamixel_sdk_custom_interfaces::srv::Movement_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = dynamixel_sdk_custom_interfaces::srv::Movement_Response;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dynamixel_sdk_custom_interfaces
max_serialized_size_key_Movement_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const dynamixel_sdk_custom_interfaces::srv::Movement_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<dynamixel_sdk_custom_interfaces::srv::Movement_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &dynamixel_sdk_custom_interfaces::srv::typesupport_fastrtps_cpp::_Movement_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dynamixel_sdk_custom_interfaces, srv, Movement_Response)() {
  return &dynamixel_sdk_custom_interfaces::srv::typesupport_fastrtps_cpp::_Movement_Response__handle;
}
...
// functions for dynamixel_sdk_custom_interfaces::srv::Movement_Request already declared above

// functions for dynamixel_sdk_custom_interfaces::srv::Movement_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dynamixel_sdk_custom_interfaces
cdr_serialize(
  const dynamixel_sdk_custom_interfaces::srv::Movement_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dynamixel_sdk_custom_interfaces::srv::Movement_Event & ros_message)
{
  // Member: info
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dynamixel_sdk_custom_interfaces
max_serialized_size_Movement_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        dynamixel_sdk_custom_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_Movement_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        dynamixel_sdk_custom_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_Movement_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = dynamixel_sdk_custom_interfaces::srv::Movement_Event;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dynamixel_sdk_custom_interfaces
max_serialized_size_key_Movement_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        dynamixel_sdk_custom_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_Movement_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        dynamixel_sdk_custom_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_Movement_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const dynamixel_sdk_custom_interfaces::srv::Movement_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<dynamixel_sdk_custom_interfaces::srv::Movement_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Movement_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const dynamixel_sdk_custom_interfaces::srv::Movement_Event *>(
...
static size_t _Movement_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Movement_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Movement_Event__callbacks = {
  "dynamixel_sdk_custom_interfaces::srv",
  "Movement_Event",
...
static rosidl_message_type_support_t _Movement_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Movement_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &dynamixel_sdk_custom_interfaces::srv::typesupport_fastrtps_cpp::_Movement_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dynamixel_sdk_custom_interfaces, srv, Movement_Event)() {
  return &dynamixel_sdk_custom_interfaces::srv::typesupport_fastrtps_cpp::_Movement_Event__handle;
}
...
static const rosidl_service_type_support_t _Movement__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Movement__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<dynamixel_sdk_custom_interfaces::srv::Movement_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<dynamixel_sdk_custom_interfaces::srv::Movement_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<dynamixel_sdk_custom_interfaces::srv::Movement_Event>(),
...
{
  return &dynamixel_sdk_custom_interfaces::srv::typesupport_fastrtps_cpp::_Movement__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dynamixel_sdk_custom_interfaces, srv, Movement)() {
  return &dynamixel_sdk_custom_interfaces::srv::typesupport_fastrtps_cpp::_Movement__handle;
}
